...
namespace CraigLib.Sound
{
    ...
    /// </summary>
    internal class LibsndfileArrayMarshal : ILibsndfileArrayMarshal
    {
        /// <summary>
        ...
        {
            var length = CalculateArrayLength<byte>(memory);
        ...
        {
            var length = CalculateArrayLength<short>(memory);
        ...
        {
            var length = CalculateArrayLength<int>(memory);
        ...
        {
            var length = CalculateArrayLength<float>(memory);
        ...
        {
            var length = CalculateArrayLength<double>(memory);
        ...
        {
            var length = CalculateArrayLength<long>(memory);
