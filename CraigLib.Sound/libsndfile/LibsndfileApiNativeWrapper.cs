...
namespace CraigLib.Sound
{
    ...
    {
        private readonly ILibsndfileMarshal m_Marshaller;

        /// <summary>
        /// Initializes a new <see cref="LibsndfileApiNativeWrapper"/> with 
        /// the default <see cref="ILibsndfileMarshal"/> implementation.
        /// </summary>
        internal LibsndfileApiNativeWrapper()
            : this(new LibsndfileMarshal())
        {
        }
        ...
        /// </summary>
        /// <param name="marshaller">ILibsndfileMarshal implementation to use.</param>
        internal LibsndfileApiNativeWrapper(ILibsndfileMarshal marshaller)
        {
            if (marshaller == null)
